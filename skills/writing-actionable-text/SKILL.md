---
name: writing-actionable-text
description: Use when writing responses, instructions, docs, runbooks, or error messages, or whenever the text must drive immediate action instead of just explaining.
---
