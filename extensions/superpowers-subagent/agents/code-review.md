...
- **Simple English:** docstrings, comments, and documentation follow the writing-unambiguous-text rules (pragmatic mode) — short sentences, imperative procedures, no banned modals (should, would, may, might, could).
