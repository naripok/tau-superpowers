...
- **Style:** the document follows writing-unambiguous-text — short sentences, imperative procedures, no banned modals (should, would, may, might, could). RFC 2119 keywords (SHALL, MUST, SHOULD) in requirement statements stay legal.
